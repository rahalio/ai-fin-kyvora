 ...
 */
export type RepositoryList<TRepo extends ReadRepository<any>> = TRepo extends ReadRepository<infer TEntity, any, any> ? PaginatedResult<TEntity> : never;
/**
 * Extract Get Result Type from Repository
 * @example RepositoryGet<ProductRepository> → Product | null
 */
export type RepositoryGet<TRepo extends ReadRepository<any>> = TRepo extends ReadRepository<infer TEntity, any, any> ? TEntity | null : never;
/**
 * Extract Create Input Type from Repository
 * @example RepositoryCreate<ProductRepository> → CreateProductRequest
 */
export type RepositoryCreate<TRepo extends CrudRepository<any, any, any>> = TRepo extends CrudRepository<any, infer TCreate, any> ? TCreate : never;
/**
 * =======================================================================
 ...
 * =======================================================================
 */
export interface ReadRepository<TEntity, TId = string, TListParams = PaginationParams> {
    /**
 ...
 */
export interface CreateReadRepository<TEntity, TCreate, TId = string, TListParams = PaginationParams> extends ReadRepository<TEntity, TId, TListParams> {
    /**
 ...
 */
export interface UpdateReadRepository<TEntity, TUpdate, TId = string, TListParams = PaginationParams> extends ReadRepository<TEntity, TId, TListParams> {
    /**
 ...
 */
export interface DeleteReadRepository<TEntity, TId = string, TListParams = PaginationParams> extends ReadRepository<TEntity, TId, TListParams> {
    /**
     * Delete a resource.
     *
 ...
 */
export interface CreateUpdateReadRepository<TEntity, TCreate, TUpdate, TId = string, TListParams = PaginationParams> extends ReadRepository<TEntity, TId, TListParams> {
    /**
     * Create a new resource.
     *
     * @operationId create<Entity>
 ...
 */
export interface CreateDeleteReadRepository<TEntity, TCreate, TId = string, TListParams = PaginationParams> extends ReadRepository<TEntity, TId, TListParams> {
    /**
     * Create a new resource.
     *
     * @operationId create<Entity>
 ...
 */
export interface UpdateDeleteReadRepository<TEntity, TUpdate, TId = string, TListParams = PaginationParams> extends ReadRepository<TEntity, TId, TListParams> {
    /**
     * Update an existing resource.
     *
     * @operationId update<Entity>
 ...
 * =======================================================================
 */
export interface CrudRepository<TEntity, TCreate, TUpdate, TId = string, TListParams = PaginationParams> extends ReadRepository<TEntity, TId, TListParams> {
    /**
     * Create a new resource.
     *
     * @operationId create<Entity>
 ...
 */
export interface SingleTenantReadRepository<TEntity, TId = string, TListParams = PaginationParams> {
    /**
     * List all resources.
     *
     * @operationId list<Entity>
 ...
 */
export interface SingleTenantCreateReadRepository<TEntity, TCreate, TId = string, TListParams = PaginationParams> extends SingleTenantReadRepository<TEntity, TId, TListParams> {
    create(data: TCreate): Promise<TEntity>;
}
/**
 * Single-tenant repository with update operation only.
 */
export interface SingleTenantUpdateReadRepository<TEntity, TUpdate, TId = string, TListParams = PaginationParams> extends SingleTenantReadRepository<TEntity, TId, TListParams> {
    update(id: TId, data: TUpdate): Promise<TEntity>;
}
/**
 * Single-tenant repository with delete operation only.
 */
export interface SingleTenantDeleteReadRepository<TEntity, TId = string, TListParams = PaginationParams> extends SingleTenantReadRepository<TEntity, TId, TListParams> {
    delete(id: TId): Promise<void>;
}
/**
 * Single-tenant repository with create and update operations.
 */
export interface SingleTenantCreateUpdateReadRepository<TEntity, TCreate, TUpdate, TId = string, TListParams = PaginationParams> extends SingleTenantReadRepository<TEntity, TId, TListParams> {
    create(data: TCreate): Promise<TEntity>;
    update(id: TId, data: TUpdate): Promise<TEntity>;
}
/**
 ...
 */
export interface SingleTenantCreateDeleteReadRepository<TEntity, TCreate, TId = string, TListParams = PaginationParams> extends SingleTenantReadRepository<TEntity, TId, TListParams> {
    create(data: TCreate): Promise<TEntity>;
    delete(id: TId): Promise<void>;
}
/**
 ...
 */
export interface SingleTenantUpdateDeleteReadRepository<TEntity, TUpdate, TId = string, TListParams = PaginationParams> extends SingleTenantReadRepository<TEntity, TId, TListParams> {
    update(id: TId, data: TUpdate): Promise<TEntity>;
    delete(id: TId): Promise<void>;
}
/**
 ...
 */
export interface SingleTenantCrudRepository<TEntity, TCreate, TUpdate, TId = string, TListParams = PaginationParams> extends SingleTenantReadRepository<TEntity, TId, TListParams> {
    create(data: TCreate): Promise<TEntity>;
    update(id: TId, data: TUpdate): Promise<TEntity>;
    delete(id: TId): Promise<void>;
}
