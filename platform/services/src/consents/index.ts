/**
 * Consents Services - Application Layer Export
 *
...
/**
 * Consents Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for consents domain.
 */
